                    ...
                    <div className="relative w-full px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        <div className="mx-auto mt-5 w-full max-w-[550px] lg:mt-16">
                            <Link to="/" className="mb-8 block lg:hidden">
                                <img src="/assets/images/emcos_logo.png" alt="Logo" className="mx-auto w-10" />
                            </Link>
                            <div className="mb-12">
                        ...
                        <p className="absolute bottom-6 w-full text-center dark:text-white">© {new Date().getFullYear()}.EMCOS All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
