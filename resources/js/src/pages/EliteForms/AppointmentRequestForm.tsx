...
function AppointmentRequestForm({ className, isEdit, initialData, onSuccess }: any) {
    ...
    const fields = [
        ...
        },
        {
            ...
            initialValue: initialData
                ? {
                      ...
                      label: `${initialData?.patient_intake?.first_name} ${initialData?.patient_intake?.middle_name || ''} ${initialData?.patient_intake?.last_name}`,
                  }
                : null,
            colSpan: 3,
            options: patients,
        ...
        },
        {
            ...
            initialValue: initialData
                ? {
                      ...
                      label: `${initialData?.provider?.first_name} ${initialData?.provider?.middle_name || ''} ${initialData?.provider?.last_name}`,
                  }
                : null,
            colSpan: 3,
        ...
        },
        {
            ...
            initialValue:
                selectedProviderType === 'Specialist'
                    ? initialData
                        ? {
                              value: initialData?.appointment_types[0]?.name,
                              label: initialData?.appointment_types[0]?.name,
                          }
                        : initialData?.appointment_types.map((item: any) => ({ ...item, value: item.name, label: item.name }))
                    : null,
            colSpan: 3,
        ...
        },
        {
            ...
            initialValue: initialData?.injection_type || '',
            colSpan: 3,
        ...
        },
        {
            ...
            initialValue: initialData
                ? {
                      value: initialData?.at_surgery_center,
                      label: initialData?.at_surgery_center,
                  }
                : surgeyCenterInjectionTypes[0],
            colSpan: 3,
        ...
        },
        {
            ...
            initialValue: initialData?.surgery_center_id
                ? {
        ...
        },
        {
            ...
            initialValue: initialData?.patient_medical_records || null,
            colSpan: 6,
            width: 'w-1/2',
        },
        {
